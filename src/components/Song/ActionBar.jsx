...
const ACTIVE_ICON_COLOR = "#FFEB3B";
...
const panelBtnSx = (active) => ({
  ...
  color: active ? ACTIVE_ICON_COLOR : "#fff",
  flexShrink: 0,
  "&:hover": {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {mdUp && onToggleColumnsExpanded && (
                <LabeledAction
                  lines={
                    columnsExpanded ? ["צמצם", "עמודות"] : ["הרחב", "עמודות"]
                  }
                  active={columnsExpanded}
                  onClick={onToggleColumnsExpanded}
                >
              ...
              <Box sx={{ position: "relative" }}>
                ...
                {scrollPopupOpen && (
                  <ClickAwayListener
                    onClickAway={() => setScrollPopupOpen(false)}
                  >
                    <Box>
                      <ScrollPopup
          ...
          {fontPanelOpen && (
            ...
            >
              ...
              <SquareBtn
                onClick={() =>
                  onFontSizeChange(Math.max(MIN_FONT, fontSize - 2))
                }
              ...
              <SquareBtn
                onClick={() =>
                  onFontSizeChange(Math.min(MAX_FONT, fontSize + 2))
                }
